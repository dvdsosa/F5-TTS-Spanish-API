...
def infer_batch_process(
    ...
    try:
        ...
        for i, gen_text in enumerate(progress.tqdm(gen_text_batches)):
            ...
            while attempts < max_attempts:
                ...
                with torch.inference_mode():
                    ...
                    sf.write(temp_file.name, generated_wave, target_sample_rate)
        ...
        with tempfile.NamedTemporaryFile(delete=False, suffix=".wav") as temp_f:
            ...
            sf.write(temp_f.name, final_wave, target_sample_rate)
            ...
            with tempfile.NamedTemporaryFile(delete=False, suffix=".wav") as processed_f:
                ...
                processed_wave, sr = sf.read(processed_f.name, dtype='float32')
                processed_wave = torch.from_numpy(processed_wave).unsqueeze(0)
